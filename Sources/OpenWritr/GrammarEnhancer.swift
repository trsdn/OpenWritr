...
struct GrammarEnhancer: Sendable {
    ...
    private func runCopilot(text: String, model: String) -> String {
        ...
        let prompt = "Fix grammar, spelling, and punctuation. Remove filler words (um, uh, er, like, you know, basically, actually, so, well, I mean). Keep the original meaning and tone. Return only the corrected text. Do not add explanations.\n\n\(text)"
